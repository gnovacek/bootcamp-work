...
// refactored to: 
	...
	public int max1020(int a, int b) {
		...
		if (b > a && bRange || (!aRange && bRange)) {
			return b;
		} else if ((a > b && aRange) || (aRange && !bRange)) {
			return a; 
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		...
		boolean cigarSuccess = (cigars >= 40 && cigars <=60); 
		if(cigarSuccess && !isWeekend) {
			return true; 
	...
	public int dateFashion(int you, int date) {
		...
		boolean maybeYou = (you <= 7 && you >= 3);  
		boolean maybeDate = (date <= 7 && date >= 3); 
		
		if(you < 3 || date < 3) {
			return 0; 
		} else if (yesTable) {
			return 2;
		} else if (maybeYou && maybeDate) {
			return 1;
		} 
		return 0; 
	}
	...
	public String alarmClock(int day, boolean vacation) {
		boolean weekdays = day >= 1 && day < 6; 
		boolean weekends = day == 0 || day == 6; 
		
		if (weekdays && !vacation) {
			return "7:00"; 
		} else if (weekends && !vacation) {
			return "10:00"; 
	...
	public boolean in1To10(int n, boolean outsideMode) {
		boolean range = (n >= 1 && n <= 10); 
		boolean rangeOut = (n <= 1 || n >= 10); 
	...
	public boolean specialEleven(int n) {
		boolean isSpecial = (n % 11 == 0) || (n % 11 == 1); 
		if(n > 0) {
			return isSpecial; 
		}
		return false;
	...
	public boolean more20(int n) {
		boolean isCorrect = (n % 20 == 1) || (n % 20 == 2); 
		if(n > 0) {
			return isCorrect; 
		}
		return false;
	...
	public boolean old35(int n) {
		boolean modThree = (n % 3 == 0);
		boolean modFive = (n % 5 == 0); 
		
		if(n > 0 && !modFive) {
			return modThree; 
		} else if (n > 0 && !modThree) {
			return modFive;
		} 
		return false; 
	} 
	...
	public int teenSum(int a, int b) {
		int sum = a + b;
		boolean luckyValA = a >= 13 && a <= 19; 
		boolean luckyValB = b >= 13 && b <= 19; 
		
		if(luckyValA || luckyValB) {
			return 19;
		} else {
			return sum; 
		}
	...
	public boolean twoAsOne(int a, int b, int c) {
		boolean firstWay = (a + b == c);
		boolean secondWay = (a + c == b);
		boolean thirdWay = (b + c == a);
