...
<body>
    <header>
    		...
    		<c:url value="/" var="homePageHref" />
            <c:url value="/alienAge" var="alienAgeURL" />
            <c:url value="/alienWeight" var="alienWeightURL" />
            <c:url value="/alienTravel" var="alienTravelURL" />
            <c:url value="/spaceForum" var="forumURL" />
            <c:url value="/spaceStore" var="storeURL" />
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="${forumURL}">Space Forum</a></li>    
            <li><a href="${storeURL}">Space Store</a></li>             
        </ul>
    </nav>