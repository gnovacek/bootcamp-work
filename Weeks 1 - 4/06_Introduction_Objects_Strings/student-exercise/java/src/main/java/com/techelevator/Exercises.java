...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String outBegin = out.substring(0, 2);
		String outEnd = out.substring(2, 4);
		return outBegin + word + outEnd;
	}
	...
	public String left2(String str) {
		...
		if (str.length() <= 2) {
			...
			String twoToMove = str.substring(0, 2);
			String remainder = str.substring(2);

			return remainder + twoToMove;
		}
	}
	...
	public String right2(String str) {
		...
		if (str.length() <= 2) {
			...
			String twoToMove = str.substring(length - 2, length);
			String remainder = str.substring(0, length - 2);
			return twoToMove + remainder;
		}
	}
	...
	public String nTwice(String str, int n) {
		...
		String startN = str.substring(0, n);
		String endN = str.substring(str.length() - n);
	...
	public int last2(String str) {
		...
		// Didn't really understand the problem or the examples, so it was hard for me to write the code 
		// starting from a very sad starting place!
	...
	public String stringX(String str) {
		...
		if (length >= 3) {
			String sub = str.substring(1, length - 1);
			sub = sub.replace("x", "");

			return str.charAt(0) + sub + str.charAt(length - 1);
		} else {
			return str;
		}
	}
